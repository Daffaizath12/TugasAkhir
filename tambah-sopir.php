...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["action"]) && $_POST["action"] == "add") {
  ...
  // Your SQL query
  $sql = "INSERT INTO sopir (nama_lengkap, no_SIM, notelp, alamat, username, password, status) VALUES ('$nama_lengkap', '$no_SIM', '$notelp', '$alamat', '$username', '$password', '$status')";
              ...
              <div class="card-body">
                ...
                <form method="post" action="tambah-sopir.php" onsubmit="return validasiForm()">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputUsername1" name="password" placeholder="Password" Required>
                  </div>
                  <div class="form-group">
